package it.univr.swing.DuePalline;
...
public class BouncingBall extends JFrame {
	...
	private final Ball ball = new Ball(0, 0);
	private final Ball ball2 = new Ball(350, 250);
	...
	private void moveBallAround() {
		while (true) {
			shiftBall(ball);
			shiftBall(ball2);
			if(Math.abs(ball.getX() - ball2.getX()) < ball.getWidth() && (Math.abs(ball.getY() - ball2.getY()) < ball2.getWidth())) {
